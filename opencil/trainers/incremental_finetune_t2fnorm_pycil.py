...
class FinetuneT2FNormLearner(BaseLearner):
        ...
        if self._cur_task == 0:
            ...
            for _, epoch in enumerate(prog_bar):
                ...
                for i, (train_datas, train_targets) in enumerate(train_loader):
                    ...
                    train_logits = self._network(train_datas, feature_operate="T2FNorm_train", feature_operate_parameter=self.config.trainer.tau)["aux_logits"]
            ...
            for _, epoch in enumerate(prog_bar):
                ...
                for i, (train_datas, train_targets) in enumerate(train_loader):
                    ...
                    val_logits = self._network(val_datas, feature_operate="T2FNorm_train", feature_operate_parameter=self.config.trainer.tau)["aux_logits"]
                    loss += F.cross_entropy(val_logits, val_targets)
