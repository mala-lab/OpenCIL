...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
        ...
        assert config is not None, "you should pass config to resnet"
    ...
    def forward_cil(self, x, return_feature=False, return_feature_list=False): #with cil
        ...
        if return_feature_list:
            feature_list = [x_pool, x_1, x_2, x_3, pooled]
...
def resnet18_224x224(pretrained=False, progress=True, **kwargs):
